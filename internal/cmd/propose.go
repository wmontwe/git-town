...
import (
	...
	"github.com/git-town/git-town/v24/internal/validate"
	"github.com/git-town/git-town/v24/internal/vm/interpreter/fullinterpreter"
	"github.com/git-town/git-town/v24/internal/vm/opcodes"
	"github.com/git-town/git-town/v24/internal/vm/optimizer"
...
func determineProposeData(repo execute.OpenRepoResult, args proposeArgs) (proposeData, configdomain.ProgramFlow, error) {
	...
	connectorOpt, detectedForgeType, err := repo.NewConnector(config.DevURL(repo.Backend))
	if err != nil {
		return emptyResult, configdomain.ProgramFlowExit, err
	}
